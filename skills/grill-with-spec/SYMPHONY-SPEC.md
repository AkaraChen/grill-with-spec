<!--
Verbatim copy of openai/symphony SPEC.md
(https://github.com/openai/symphony/blob/main/SPEC.md).
Copyright 2025 OpenAI. Licensed under the Apache License, Version 2.0; see
SYMPHONY-SPEC.LICENSE next to this file. Not covered by this repository's MIT license.
Bundled as the calibration exemplar for grill-with-spec; see EXAMPLE-SPEC.md for how to use it.
-->
